...
public class FakeTweetsBatchSpout implements IBatchSpout {
    ...
    public final static String[] ACTORS = { "stefan", "dave", "eugene", "nathan", "doug", "ted", "mary",
            "rose" };
    ...
    public void open(Map conf, TopologyContext context) {
        ...
        try {
            ...
            InputStream stream =contextClassLoader.getResourceAsStream("500_sentences_en.txt");

            sentences = (String[]) IOUtils.readLines(stream).toArray(new String[0]);
        } catch(IOException e) {
